...
import com.qihoo360.BuildConfig;
...
public class RePlugin {
    ...
    /**
     * RePlugin 中，针对 Application 的入口类 <p>
     * 所有针对 Application 的调用应从此类开始
     *
     * @author RePlugin Team
     */
    public static class App {
        ...
        /**
         * 标志框架是否已经 attached，即 attachBaseContext 方法被正确调用
         */
        static boolean sAttached;

        /**
         * 当 Application 的 attachBaseContext 调用时需调用此方法 <p>
         * 使用插件框架默认的方案
         *
        ...
        /**
         * 当 Application的attachBaseContext 调用时触发 <p>
         * 可自定义插件框架的回调行为。参见 RePluginCallbacks 类的说明
         * 此方法的定制性不如 RePluginConfig 的版本
         *
         * @param app Application 对象
         * @param pc  可供外界使用的回调
         * @see Application#attachBaseContext(Context)
        ...
        /**
         * 当 Application 的 onLowMemory 调用时触发 <p>
         * 除了插件化框架本身会做一些事情外，该方法也来通知插件 onLowMemory 的行为
         * <p>
         * 如果 App 的 minSdkVersion >= 14，该方法不用调用
         *
         * @see Application#onLowMemory()
         */
        public static void onLowMemory() {
            // API>=14（ICE_CREAM_SANDWICH）采用注册回调的方式执行插件中该方法
        ...
        /**
         * 当 Application 的 onTrimMemory 调用时触发 <p>
         * 除了插件化框架本身会做一些事情外，该方法也来通知插件 onTrimMemory 的行为
         * <p>
        ...
        /**
         * 当 Application 的 onConfigurationChanged 调用时触发 <p>
         * 除了插件化框架本身会做一些事情外，该方法也来通知插件 onConfigurationChanged 的行为
         * <p>
         * 如果App的minSdkVersion >= 14，该方法不用调用
         *
